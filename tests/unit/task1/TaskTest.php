...
class TaskTest extends \Codeception\Test\Unit
{
     ...
     * @param $n
     * @param $result
     * @dataProvider failValidateDataProvider
     */
    public function testArrayDiffFeature($n, $result)
    {
        $this->tester->assertTrue($this->diff(fillSpiralMatrix($n), $result));
    }

    /**
     * @return array
     */
    public function failValidateDataProvider()
    {
        $fixtures1000 = require_once __DIR__  .'/../../_fixtures/task1/1000.php';
        return [
            '=> (Task 1 - Fill Spiral Matrix n = 1)' => [2, [[1, 2], [4, 3]]],
            '=> (n = 5)' => [5,
                [
                    [1, 2, 3, 4, 5],
                    [16, 17, 18, 19, 6],
